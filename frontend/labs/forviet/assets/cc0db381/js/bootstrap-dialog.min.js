! function(t, e) {
    ...
    var e = t.fn.modal.Constructor,
        n = function(n, o) {
            return /4\.1\.\d+/.test(t.fn.modal.Constructor.VERSION) ? new e(n, o) : void e.call(this, n, o)
        };
    n.getModalVersion = function() {
        var e = null;
        return e = "undefined" == typeof t.fn.modal.Constructor.VERSION ? "v3.1" : /3\.2\.\d+/.test(t.fn.modal.Constructor.VERSION) ? "v3.2" : /3\.3\.[1,2]/.test(t.fn.modal.Constructor.VERSION) ? "v3.3" : /4\.\d\.\d+/.test(t.fn.modal.Constructor.VERSION) ? "v4.1" : "v3.3.4"
    ...
    }, n.METHODS_TO_OVERRIDE["v3.3.4"] = t.extend({}, n.METHODS_TO_OVERRIDE["v3.3"]), n.METHODS_TO_OVERRIDE["v4.1"] = t.extend({}, n.METHODS_TO_OVERRIDE["v3.3"]), n.prototype = {
        constructor: n,
    ...
    return o.BootstrapDialogModal = n, o.NAMESPACE = "bootstrap-dialog", o.TYPE_DEFAULT = "type-default", o.TYPE_INFO = "type-info", o.TYPE_PRIMARY = "type-primary", o.TYPE_SECONDARY = "type-secondary", o.TYPE_SUCCESS = "type-success", o.TYPE_WARNING = "type-warning", o.TYPE_DANGER = "type-danger", o.TYPE_DARK = "type-dark", o.TYPE_LIGHT = "type-light", o.DEFAULT_TEXTS = {}, o.DEFAULT_TEXTS[o.TYPE_DEFAULT] = "Default", o.DEFAULT_TEXTS[o.TYPE_INFO] = "Information", o.DEFAULT_TEXTS[o.TYPE_PRIMARY] = "Primary", o.DEFAULT_TEXTS[o.TYPE_SECONDARY] = "Secondary", o.DEFAULT_TEXTS[o.TYPE_SUCCESS] = "Success", o.DEFAULT_TEXTS[o.TYPE_WARNING] = "Warning", o.DEFAULT_TEXTS[o.TYPE_DANGER] = "Danger", o.DEFAULT_TEXTS[o.TYPE_DARK] = "Dark", o.DEFAULT_TEXTS[o.TYPE_LIGHT] = "Light", o.DEFAULT_TEXTS.OK = "OK", o.DEFAULT_TEXTS.CANCEL = "Cancel", o.DEFAULT_TEXTS.CONFIRM = "Confirmation", o.SIZE_NORMAL = "size-normal", o.SIZE_SMALL = "size-small", o.SIZE_LARGE = "size-large", o.SIZE_WIDE = "size-wide", o.BUTTON_SIZES = {}, o.BUTTON_SIZES[o.SIZE_NORMAL] = "", o.BUTTON_SIZES[o.SIZE_SMALL] = "btn-sm", o.BUTTON_SIZES[o.SIZE_LARGE] = "btn-lg", o.BUTTON_SIZES[o.SIZE_WIDE] = "", o.ICON_SPINNER = "glyphicon glyphicon-asterisk", o.BUTTONS_ORDER_CANCEL_OK = "btns-order-cancel-ok", o.BUTTONS_ORDER_OK_CANCEL = "btns-order-ok-cancel", o.defaultOptions = {
        ...
        updateZIndex: function() {
            if (this.isOpened()) {
                ...
                var a = this.getModal(),
                    s = this.getModalBackdrop(a);
                a.css("z-index", n + 20 * (i - 1)), s.css("z-index", e + 20 * (i - 1))
            }
            return this
        },
        open: function() {
    ...
    }, o.METHODS_TO_OVERRIDE["v3.3"] = {}, o.METHODS_TO_OVERRIDE["v3.3.4"] = t.extend({}, o.METHODS_TO_OVERRIDE["v3.1"]), o.METHODS_TO_OVERRIDE["v4.0"] = o.METHODS_TO_OVERRIDE["v4.1"] = {
        defaultButtonCss: "btn-outline-secondary",
        getModalBackdrop: function(e) {
            return t(e.data("bs.modal")._backdrop)
        },
        handleModalBackdropEvent: o.METHODS_TO_OVERRIDE["v3.1"].handleModalBackdropEvent,
        updateZIndex: o.METHODS_TO_OVERRIDE["v3.1"].updateZIndex,
        open: o.METHODS_TO_OVERRIDE["v3.1"].open,
        ...
        createModalHeader: function() {
            var e = this.getNamespace("header");
            return t('<div class="modal-header ' + e + '"></div>')
        },
        createHeaderContent: function() {
            var e = t("<div></div>");
            return e.append(this.createTitleContent()).append(this.createCloseButton()), e.html()
        }
    }, o.prototype = {
        constructor: o,
        ...
        getModalBackdrop: function(t) {
            return t.data("bs.modal").$backdrop
        },
        getModalForBootstrapDialogModal: function() {
        ...
        updateType: function() {
            if (this.isRealized()) {
                var t = [o.TYPE_DEFAULT, o.TYPE_INFO, o.TYPE_PRIMARY, o.TYPE_SECONDARY, o.TYPE_SUCCESS, o.TYPE_WARNING, o.TYPE_DARK, o.TYPE_LIGHT, o.TYPE_DANGER];
        ...
        updateSize: function() {
            if (this.isRealized()) {
                ...
                this.getModal().removeClass(o.SIZE_NORMAL).removeClass(o.SIZE_SMALL).removeClass(o.SIZE_LARGE).removeClass(o.SIZE_WIDE), this.getModal().addClass(n), this.getModalDialog().removeClass("modal-sm"), n === o.SIZE_SMALL && this.getModalDialog().addClass("modal-sm"), this.getModalDialog().removeClass("modal-lg"), n === o.SIZE_LARGE && this.getModalDialog().addClass("modal-lg"), this.getModalDialog().removeClass("modal-xl"), n === o.SIZE_WIDE && this.getModalDialog().addClass("modal-xl"), t.each(this.options.buttons, function(n, o) {
                    ...
                    s || (i.removeClass(a.join(" ")), i.addClass(e.getButtonSize()))
                })
            }
            return this
        },
        ...
        createCloseButton: function() {
            ...
            var n = t('<button class="close" data-dismiss="modal" aria-label="close"></button>');
        ...
        createFooterButtons: function() {
            ...
            return n.addClass(this.getNamespace("footer-buttons")), this.indexedButtons = {}, t.each(this.options.buttons, function(t, i) {
                i.id || (i.id = o.newGuid());
                var a = e.createButton(i);
                e.indexedButtons[i.id] = a, n.append(a)
            }), n
        },
        createButton: function(e) {
            var n = t('<button class="btn"></button>');
            return n.prop("id", e.id), n.data("button", e), "undefined" != typeof e.icon && "" !== t.trim(e.icon) && n.append(this.createButtonIcon(e.icon)), "undefined" != typeof e.label && n.append(e.label), "undefined" != typeof e.title && n.attr("title", e.title), "undefined" != typeof e.cssClass && "" !== t.trim(e.cssClass) ? n.addClass(e.cssClass) : n.addClass(this.defaultButtonCss), "object" == typeof e.data && e.data.constructor === {}.constructor && t.each(e.data, function(t, e) {
                n.attr("data-" + t, e)
        ...
        return e.btnsOrder === o.BUTTONS_ORDER_OK_CANCEL && a.reverse(), i.addButtons(a), i.open()
